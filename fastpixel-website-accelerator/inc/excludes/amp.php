...
if (!class_exists('FASTPIXEL\FASTPIXEL_Exclude_Amp')) {
    class FASTPIXEL_Exclude_Amp extends FASTPIXEL_Exclude {
        public function __construct() {
            parent::__construct();
            add_filter('fastpixel_excluded_post_types', array($this, 'exclude_post_type'));
            add_filter('fastpixel_purge_excluded_post_types', array( $this, 'exclude_post_type') );
        }
